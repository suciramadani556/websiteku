    ...
    <header class="py-5 bg-light border-bottom mb-4">
        <div class="container">
            <div class="text-center my-5">
                ...
                <p class="lead mb-0">Terima kasih sudah mengunjungi website kami</p>
            </div>
        </div>
    </header>
    <!-- Page content-->
                    ...
                    if ($featured) : ?>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a class="btn btn-warning" href="blogpost.php?id=<?= $row['id_artikel'] ?>">Read more →</a>
                            </div>
                        </div>
                        ...
                        $featured = false;
                            ...
                            <div class="col-lg-6">
                                <!-- Blog post-->
                                <div class="card mb-4">
                                    <a href="blogpost.php?id=<?= $row['id_artikel'] ?>"><img class="card-img-top" src="data:image/jpeg;base64,<?= base64_encode($row['gambar']) ?>" alt="..." width="700" height="350" /></a>
                                    <div class="card-body">
                                        <div class="small text-muted"><?= ($row['tanggal']) ?></div>
                                        <h2 class="card-title h4"><?= $row['judul'] ?></h2>
                                        <p class="card-text"><?= substr($row['isi'], 0, 100) ?>...</p>
                                        <a class="btn btn-warning" href="blogpost.php?id=<?= $row['id_artikel'] ?>">Read
                                            more →</a>
                                    </div>
                                </div>
                            </div>
